...
func (c *healthServiceClient) Check(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*CheckResponse, error) {
	out := new(CheckResponse)
	err := c.cc.Invoke(ctx, "/greet.v1.HealthService/Check", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedHealthServiceServer) Check(context.Context, *emptypb.Empty) (*CheckResponse, error) {
...
func _HealthService_Check_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/greet.v1.HealthService/Check",
	}
...
var HealthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "greet.v1.HealthService",
	...
	Metadata: "greet/v1/health.proto",
}
